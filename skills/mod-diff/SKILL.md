...
```bash
python skills/mod-diff/scripts/mod_diff.py --game "<game-path>"            # whole install
python skills/mod-diff/scripts/mod_diff.py --game "<game-path>" --type DLG # one type
```
...
```bash
python skills/mod-diff/scripts/mod_diff.py --game "<modded>" --against "<clean-ref-dir-or-file>"
```

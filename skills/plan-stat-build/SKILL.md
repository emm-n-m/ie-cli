...
```bash
python skills/map-stat-gates/scripts/gate_payoffs.py   --game "<game-path>" --protagonist Protagonist  # value: lead here
python skills/map-stat-gates/scripts/gate_histogram.py --game "<game-path>" --protagonist Protagonist  # volume: secondary
```
...
```bash
python skills/plan-stat-build/scripts/stat_economy.py --game "<game-path>" --protagonist Protagonist
